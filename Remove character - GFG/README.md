...
from string1 we get "ompuer"</span><span style="font-size: 18px;">.</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
(c, a, r) from string1 we get "ouene"</span><span style="font-size: 18px;">.</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
<p>&nbsp;</p>
