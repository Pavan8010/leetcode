...
<pre style="position: relative;"><strong>Input:</strong> colors = "AAABABB"
...
<pre style="position: relative;"><strong>Input:</strong> colors = "AA"
...
<pre style="position: relative;"><strong>Input:</strong> colors = "ABBBBBBBAAA"
<strong>Output:</strong> false
<strong>Explanation:</strong>
