...
<pre style="position: relative;"><strong>Input:</strong> cardPoints = [1,2,3,4,5,6,1], k = 3
...
<pre style="position: relative;"><strong>Input:</strong> cardPoints = [2,2,2], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> cardPoints = [9,7,7,9,7,7,9], k = 7
