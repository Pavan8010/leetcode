...
<pre style="position: relative;"><strong>Input:</strong> s = "leet2code3", k = 10
...
<pre style="position: relative;"><strong>Input:</strong> s = "ha22", k = 5
...
<pre style="position: relative;"><strong>Input:</strong> s = "a2345678999999999999999", k = 1
