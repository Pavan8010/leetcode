...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,3,5,2], cost = [2,3,1,14]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,2,2,2,2], cost = [4,2,8,1,3]
